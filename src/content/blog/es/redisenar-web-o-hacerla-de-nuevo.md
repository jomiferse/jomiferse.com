---
title: "¿Rediseñar una web o hacerla de nuevo? Costes, riesgos y cómo decidir"
metaTitle: "¿Rediseñar una web o hacerla de nuevo?"
description: "Criterios para decidir si conviene rediseñar una web existente, modernizarla por fases o reconstruirla sin perder contenido, medición ni SEO."
date: 2026-08-12
language: "es"
author: "José Miguel Fernández"
readingTime: "10 min"
homeFeatured: 2
translationSlug: "redesign-website-or-rebuild"
commercial:
  role: buyer-led
  audience: business
  cluster: website-redesign
cover:
  src: "/images/blog/covers/redesign-website-or-rebuild.avif"
  alt: "Ilustración de una web antigua que pasa por un diagnóstico antes de rediseñarse o reconstruirse"
tags: [rediseno-web, migracion-web, seo, wordpress, astro, pymes]
---
...
Un [servicio de rediseño web](/es/services/website-redesign/) debería empezar por este diagnóstico. Cambiar colores antes de entender los problemas puede dejar intacta la parte que frena contactos.
...
1. inventariar páginas, integraciones y datos
2. medir el recorrido principal
3. rediseñar inicio, servicio prioritario y contacto
4. comprobar uso, formularios e indexación
5. migrar el resto por grupos
6. retirar dependencias antiguas cuando ya no tengan tráfico ni función
...
El presupuesto depende del número de plantillas, el estado del contenido, las integraciones y la migración. La guía sobre [cuánto cuesta una página web para una pyme](/es/blog/cuanto-cuesta-pagina-web-pyme/) ofrece rangos para comparar tipos de proyecto.
...
La [documentación oficial de Google sobre migraciones](https://developers.google.com/search/docs/crawling-indexing/site-move-with-url-changes?hl=es) recomienda preparar el sitio nuevo, crear el mapa de URLs, configurar las redirecciones y vigilar Search Console durante el cambio. La visibilidad puede fluctuar mientras Google vuelve a rastrear las páginas, por lo que la revisión no termina el día del lanzamiento.

Comprueba además:

1. canonicals y hreflang si hay idiomas
2. títulos, descripciones y encabezados
3. robots, sitemap y páginas bloqueadas
4. datos estructurados
5. códigos 404 y cadenas de redirección
6. enlaces internos y externos importantes
7. analítica, consentimientos y eventos de contacto
8. formularios y emails transaccionales
...
Si solicitas propuestas, revisa también [cómo evaluar un presupuesto de software](/es/blog/evaluar-presupuesto-software-a-medida/). Aunque el encargo sea una web, siguen importando las exclusiones, la propiedad, las pruebas y el mantenimiento.
