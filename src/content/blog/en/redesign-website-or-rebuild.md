---
title: "Should you redesign or rebuild your website? Cost, risk and a practical decision"
metaTitle: "Should You Redesign or Rebuild Your Website?"
description: "A practical way to choose between redesigning, phasing a website modernization or rebuilding without losing content, measurement or SEO."
date: 2026-08-12
language: "en"
author: "José Miguel Fernández"
readingTime: "10 min"
homeFeatured: 2
translationSlug: "redisenar-web-o-hacerla-de-nuevo"
commercial:
  role: buyer-led
  audience: business
...
cover:
  ...
  alt: "Illustration of an old website being assessed before a redesign or rebuild"
tags:
  [website-redesign, website-migration, seo, wordpress, astro, small-business]
---
...
A [website redesign service](/en/services/website-redesign/) should start with this diagnosis. Changing colours before understanding the problem can leave the broken enquiry path untouched.
...
1. inventory pages, integrations and data
2. measure the main journey
3. redesign home, the priority service and contact
4. verify use, forms and indexation
5. migrate the remaining sections in groups
6. remove old dependencies once they have no traffic or purpose
...
The budget depends on template count, content quality, integrations and migration. The guide to [small-business website cost](/en/blog/how-much-does-small-business-website-cost/) provides ranges for different project types.
...
[Google's official site-move documentation](https://developers.google.com/search/docs/crawling-indexing/site-move-with-url-changes) recommends preparing and testing the new site, mapping old URLs, configuring redirects and monitoring Search Console after the move. Visibility can fluctuate while pages are crawled again, so the review continues after launch.

Also check:

1. canonicals and hreflang for multilingual sites
2. titles, descriptions and headings
3. robots rules, sitemap and blocked pages
4. structured data
5. 404 responses and redirect chains
6. important internal and external links
7. analytics, consent and enquiry events
8. forms and transactional email
...
If you request proposals, the guide to [evaluating a custom software proposal](/en/blog/evaluate-custom-software-proposal/) covers exclusions, ownership, testing and maintenance. Those questions still matter when the deliverable is a website.
